...
@JsonPropertyOrder("SubmissionDate", "uuid", "start", "today", "deviceid", "subscriberid", "email", "username", "simserial", "phonenumber", "banner", "intro", "project", "country", "login", "firstName", "surName", "geopoint-Latitude", "geopoint-Longitude", "geopoint-Altitude", "geopoint-Accuracy", "noteBarcode", "plotLabel", "plotID", "fieldbookID", "trialCode", "fieldLabel", "fieldID", "trialID", "end", "instanceID", "KEY")
class ReplaceTlAcDto {
