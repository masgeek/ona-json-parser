...
@JsonPropertyOrder("SubmissionDate", "uuid", "start", "today", "deviceid", "subscriberid", "email", "username", "simserial", "phonenumber", "banner", "intro", "project", "country", "login", "firstName", "surName", "geopoint-Latitude", "geopoint-Longitude", "geopoint-Altitude", "geopoint-Accuracy", "entity", "basketType", "basketFloat", "correctionNote1", "basketAir", "basketWater", "correctionNote2", "correctionBasket", "repeat", "SET-OF-assessStarch", "end", "instanceID", "KEY")
class StarchContentAcDto {
    ...
    @JsonProperty("correctionNote1")
    var correctionNote1: String? = null

    @JsonProperty("basketAir")
    var basketAir: String? = null

    @JsonProperty("basketWater")
    var basketWater: String? = null

    @JsonProperty("correctionNote2")
    var correctionNote2: String? = null

    @JsonProperty("correctionBasket")
