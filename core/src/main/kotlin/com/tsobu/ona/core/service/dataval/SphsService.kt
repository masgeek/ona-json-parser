...
constructor(
    ...
    fun readJsonAsset() {
        ...
        list.forEach { sphs ->
            ...
            log.info("Parsing data for ${sphsEntity.controlKey} with date of ${sphs.dateWeeding1}")
            sphsEntity.dateWeeding1 = myDateUtil.convertToDate(sphs.dateWeeding1)
            sphsEntity.dateWeeding2 = myDateUtil.convertToDate(sphs.dateWeeding2)
            sphsEntity.dateWeeding3 = myDateUtil.convertToDate(sphs.dateWeeding3)
            sphsEntity.dateWeeding4 = myDateUtil.convertToDate(sphs.dateWeeding4)
            sphsEntity.dateWeeding5 = myDateUtil.convertToDate(sphs.dateWeeding5)
            sphsEntity.dateWeeding6 = myDateUtil.convertToDate(sphs.dateWeeding6)
            sphsEntity.dateWeeding7 = myDateUtil.convertToDate(sphs.dateWeeding7)
            sphsEntity.dateWeeding8 = myDateUtil.convertToDate(sphs.dateWeeding8)
            sphsEntity.dateWeeding9 = myDateUtil.convertToDate(sphs.dateWeeding9)
            sphsEntity.dateWeeding10 = myDateUtil.convertToDate(sphs.dateWeeding10)
