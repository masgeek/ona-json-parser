...
class SphsEntity : BaseEntity() {
    ...
    @Column(name = "eff_harvest_date_con")
    var effHarvestDateCon: LocalDateTime? = null
    ...
    var effHarvestDateRec: LocalDateTime? = null
    ...
    var effHarvestDateConTri: LocalDateTime? = null
    ...
    @Column(name = "eff_harvest_date_rec_tri")
    var effHarvestDateRecTri: LocalDateTime? = null
